...
--
-- 3. Heavy Single-Tier Spells: Enter "Death", "Kaustra", "Impact", or "Break".
...
--    "Break" is Earth-elemental and deals no direct damage -- magic bursting
--    it only boosts magic accuracy (a more reliable Petrify), not damage.
--    Situational: set it on Umbra/Darkness/Gravitation/Scission (Break's
--    valid burst windows) only when you specifically want that, since it
--    replaces whatever damage spell would otherwise burst that window.
BurstMagic = {
...
-- NOTE FOR SINGLE-TIER SPELLS (Death, Kaustra, Impact, Break): These spells are hard-mapped
