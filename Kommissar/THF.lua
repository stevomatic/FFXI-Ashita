...
local sets = {
    ...
    ['Preshot'] = {
        Range = 'Jinx Discus',
		Ammo = 'Displaced',
        Head = 'Pursuer\'s Beret', -- path a revetaur 6 mithkabobs --
        Body = 'Pursuer\'s Doublet', -- path a ferrodon --
        Hands = 'Carmine Fin. Ga. +1',
        Ring2 = 'Crepuscular Ring',
        Back = 'Toutatis\'s Cape', -- snapshot --
        Waist = 'Yemaya Belt', 
        Legs = 'Pursuer\'s Pants', -- path A vyalet--
        Feet = 'Pursuer\'s Gaiters', -- path A or D  wepwawet -- 
    },
    ['Midshot'] = {
        Range = 'Jinx Discus',
		Ammo = 'Displaced',
