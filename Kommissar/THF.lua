...
local sets = {
    ...
    ['Preshot'] = {
        Range = 'Jinxed Discus',
		Ammo = 'Displaced',
        Head = 'Pursuer\'s Beret', -- path a --
        Body = 'Pursuer\'s Doublet', -- path a --
        Hands = 'Carmine Fin. Ga. +1',
        Ring1 = 'Aife\'s Ring',
        Ring2 = 'Crepusular Ring', -- haverton ring --
        Back = 'Toutatis\'s Mantle', -- snapshot --
        Waist = 'Yemaya Belt', 
        Legs = 'Pursuer\'s Pants', -- path A --
        Feet = 'Pursuer\'s Gaiters', -- path A or D -- 
    },
    ['Midshot'] = {
        Range = 'Jinxed Discus',
		Ammo = 'Displaced',
