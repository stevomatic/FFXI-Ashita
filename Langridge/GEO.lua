...
local sets = {
    Idle = {
        ...
        Ear2 = 'Hearty Earring',
        Body = 'Azimuth Coat +2',
        Hands = 'Azimuth Gloves +2', -- 12 --
        Ring1 = 'Stikini Ring +1',
        Ring2 = 'Murky Ring', -- 10 --
        Back = 'Nantosuelta\'s Cape',
        Waist = 'Isa Belt',
        Legs = 'Nyame Flanchard', -- 8 --
        Feet = 'Azimuth Gaiters +2', -- 11 --
    },
    Resting = {
        Main = 'Solstice',
        Sub = 'Ammurapi Shield',
    ...
    ImpactPrecast = {
        ...
        Hands = 'Merlinic Dastanas',   -- 7--
        Ring1 = 'Prolix Ring',       -- 5 prolix or lebeche if no weather--
        Ring2 = 'Kishar Ring',         -- 4-- 
        Back = 'Nantosuelta\'s Cape',  --10--
