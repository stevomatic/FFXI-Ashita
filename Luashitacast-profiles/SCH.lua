...
local sets = {
    ...
    Regen = { 
        ...
        Legs = 'Telchine Brconi',  -- regen pot +3 --
	...
	Elemental = {
        ...
        Ring2 = 'Freke Ring',
        Back = 'Lugh\'s Cape', -- int mab macc/damage --
	...
	Kaustra = {
        ...
        Ring1 = 'Freke Ring',
        Ring2 = 'Archon Ring',
        Back = 'Lugh\'s Cape', -- INT mab macc/dmg -- 
        Waist = 'Hachirin-No-Obi',
...
-- Single Precast set for everything
...
profile.HandleMidcast = function()
    ...
    -- 6. Direct Named overrides for unique skill types
